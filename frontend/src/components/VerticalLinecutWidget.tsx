...
//   linecuts: Linecut[];
//   qXVector: number[]; // Add qXVector for q-space conversion
...
//   // Calculate min and max q values from qXVector
//   const minQXValue = parseFloat(Math.min(...qXVector).toFixed(1));
//   const maxQXValue = parseFloat(Math.max(...qXVector).toFixed(1));
...
//                       step={0.1}
//                       onChange={(e) =>
//                         updateVerticalLinecutPosition(linecut.id, parseFloat(e.target.value) || 0)
//                       }
//                       className="border rounded w-20 text-center"
//                       disabled={linecut.hidden}
//                     />
